...
<head>
        <meta charset="UTF-8">
        <title>Online Familly Shop Admin  </title>
...
<div class="sidebar">
    <div class="site-width">
        ...
        <ul id="side-menu" class="sidebar-menu">
            ...
            <li class="dropdown">                 
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Product</a>                               
                        <ul class="sub-menu">
                            <li><a href="{{route('product')}}"><i class="icon-lock"></i> Manage Product</a></li>
                        </ul>                      
                    </li>
                </ul>                   
            </li>
            ...
            <li class="dropdown">                 
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Payment Getwaye</a>                               
                        <ul class="sub-menu">
                            <li><a href="#"><i class="icon-lock"></i> Manage Payment</a></li>
                        </ul>                      
                    </li>
                </ul>                   
            </li>
